...
describe('LinkedIn companion HTTP journey', () => {
  it('pairs with one short code, exposes no device token to the browser session, and can be revoked', async () => {
    ...
    expect(created.body.command).toContain('npx --yes --package=https://github.com/leanchain/trevra/releases/download/companion-v0.2.1/trevra-0.2.1.tgz trevra linkedin install --pair');
