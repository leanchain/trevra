...
| 5   | **Preview the plan**          | a `POST /api/linkedin/plan` has returned slots     | `/outreach` — writes nothing                                                                                                                                                                                                                                                                                            |
